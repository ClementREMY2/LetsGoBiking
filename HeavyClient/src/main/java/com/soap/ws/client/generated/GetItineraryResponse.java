 ...
 *       &lt;sequence&gt;
 *         &lt;element name="getItineraryResult" type="{http://schemas.datacontract.org/2004/07/RoutingServer}Itineraries" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetItineraryResponse {
    ...
    protected JAXBElement<Itineraries> getItineraryResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Itineraries }{@code >}
     *     
     */
    public JAXBElement<Itineraries> getGetItineraryResult() {
     ...
     *     
     */
    public void setGetItineraryResult(JAXBElement<Itineraries> value) {
